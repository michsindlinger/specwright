...
mkdir -p "$GLOBAL_DIR/templates/sdlc/vorhaben"
mkdir -p "$GLOBAL_DIR/templates/sdlc/projekt"
mkdir -p "$GLOBAL_DIR/templates/sdlc/hooks"
...
mkdir -p "$GLOBAL_DIR/templates/documents"
mkdir -p "$GLOBAL_DIR/templates/json"
mkdir -p "$GLOBAL_DIR/templates/schemas"
mkdir -p "$GLOBAL_DIR/templates/concept"
mkdir -p "$GLOBAL_DIR/templates/market-validation"
mkdir -p "$GLOBAL_DIR/templates/knowledge"
mkdir -p "$GLOBAL_DIR/templates/research"
...
echo "-> SDLC v4 templates (14)..."
download_file "$REPO_URL/specwright/templates/sdlc/README.md" "$GLOBAL_DIR/templates/sdlc/README.md"
download_file "$REPO_URL/specwright/templates/sdlc/vorhaben/intent-template.md" "$GLOBAL_DIR/templates/sdlc/vorhaben/intent-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/vorhaben/spec-template.md" "$GLOBAL_DIR/templates/sdlc/vorhaben/spec-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/vorhaben/plan-template.md" "$GLOBAL_DIR/templates/sdlc/vorhaben/plan-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/projekt/product-brief-template.md" "$GLOBAL_DIR/templates/sdlc/projekt/product-brief-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/projekt/architecture-template.md" "$GLOBAL_DIR/templates/sdlc/projekt/architecture-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/projekt/security-template.md" "$GLOBAL_DIR/templates/sdlc/projekt/security-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/projekt/design-template.md" "$GLOBAL_DIR/templates/sdlc/projekt/design-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/projekt/CLAUDE-template.md" "$GLOBAL_DIR/templates/sdlc/projekt/CLAUDE-template.md"
download_file "$REPO_URL/specwright/templates/sdlc/hooks/README.md" "$GLOBAL_DIR/templates/sdlc/hooks/README.md"
download_file "$REPO_URL/specwright/templates/sdlc/hooks/settings.json" "$GLOBAL_DIR/templates/sdlc/hooks/settings.json"
download_file "$REPO_URL/specwright/templates/sdlc/hooks/protect-tests.sh" "$GLOBAL_DIR/templates/sdlc/hooks/protect-tests.sh"
download_file "$REPO_URL/specwright/templates/sdlc/hooks/no-secrets.sh" "$GLOBAL_DIR/templates/sdlc/hooks/no-secrets.sh"
download_file "$REPO_URL/specwright/templates/sdlc/hooks/production-gate.sh" "$GLOBAL_DIR/templates/sdlc/hooks/production-gate.sh"
...
# v3.14: shared user-action detection rules
download_file "$REPO_URL/specwright/templates/docs/user-action-detection-rules.md" "$GLOBAL_DIR/templates/docs/user-action-detection-rules.md"
...
echo "-> Document templates (16)..."
download_file "$REPO_URL/specwright/templates/documents/product-brief.md" "$GLOBAL_DIR/templates/documents/product-brief.md"
download_file "$REPO_URL/specwright/templates/documents/product-brief-lite.md" "$GLOBAL_DIR/templates/documents/product-brief-lite.md"
download_file "$REPO_URL/specwright/templates/documents/tech-stack.md" "$GLOBAL_DIR/templates/documents/tech-stack.md"
download_file "$REPO_URL/specwright/templates/documents/roadmap.md" "$GLOBAL_DIR/templates/documents/roadmap.md"
download_file "$REPO_URL/specwright/templates/documents/architecture-decision.md" "$GLOBAL_DIR/templates/documents/architecture-decision.md"
download_file "$REPO_URL/specwright/templates/documents/architecture-structure.md" "$GLOBAL_DIR/templates/documents/architecture-structure.md"
download_file "$REPO_URL/specwright/templates/documents/competitor-analysis.md" "$GLOBAL_DIR/templates/documents/competitor-analysis.md"
download_file "$REPO_URL/specwright/templates/documents/market-position.md" "$GLOBAL_DIR/templates/documents/market-position.md"
download_file "$REPO_URL/specwright/templates/documents/design-system.md" "$GLOBAL_DIR/templates/documents/design-system.md"
download_file "$REPO_URL/specwright/templates/documents/definition-of-done.md" "$GLOBAL_DIR/templates/documents/definition-of-done.md"
download_file "$REPO_URL/specwright/templates/documents/definition-of-ready.md" "$GLOBAL_DIR/templates/documents/definition-of-ready.md"
download_file "$REPO_URL/specwright/templates/documents/story.md" "$GLOBAL_DIR/templates/documents/story.md"
download_file "$REPO_URL/specwright/templates/documents/stil-tone.md" "$GLOBAL_DIR/templates/documents/stil-tone.md"
download_file "$REPO_URL/specwright/templates/documents/seo-keywords.md" "$GLOBAL_DIR/templates/documents/seo-keywords.md"
download_file "$REPO_URL/specwright/templates/documents/landing-page-module-structure.md" "$GLOBAL_DIR/templates/documents/landing-page-module-structure.md"
download_file "$REPO_URL/specwright/templates/documents/landingpage-contents.md" "$GLOBAL_DIR/templates/documents/landingpage-contents.md"

# Market validation templates (7)
echo "-> Market validation templates (7)..."
download_file "$REPO_URL/specwright/templates/market-validation/product-brief.md" "$GLOBAL_DIR/templates/market-validation/product-brief.md"
download_file "$REPO_URL/specwright/templates/market-validation/competitor-analysis.md" "$GLOBAL_DIR/templates/market-validation/competitor-analysis.md"
download_file "$REPO_URL/specwright/templates/market-validation/market-positioning.md" "$GLOBAL_DIR/templates/market-validation/market-positioning.md"
download_file "$REPO_URL/specwright/templates/market-validation/validation-plan.md" "$GLOBAL_DIR/templates/market-validation/validation-plan.md"
download_file "$REPO_URL/specwright/templates/market-validation/validation-results.md" "$GLOBAL_DIR/templates/market-validation/validation-results.md"
download_file "$REPO_URL/specwright/templates/market-validation/ad-campaigns.md" "$GLOBAL_DIR/templates/market-validation/ad-campaigns.md"
download_file "$REPO_URL/specwright/templates/market-validation/analytics-setup.md" "$GLOBAL_DIR/templates/market-validation/analytics-setup.md"

# Knowledge templates (5)
echo "-> Knowledge templates (5)..."
download_file "$REPO_URL/specwright/templates/knowledge/knowledge-index-template.md" "$GLOBAL_DIR/templates/knowledge/knowledge-index-template.md"
download_file "$REPO_URL/specwright/templates/knowledge/api-contracts-template.md" "$GLOBAL_DIR/templates/knowledge/api-contracts-template.md"
download_file "$REPO_URL/specwright/templates/knowledge/data-models-template.md" "$GLOBAL_DIR/templates/knowledge/data-models-template.md"
download_file "$REPO_URL/specwright/templates/knowledge/shared-services-template.md" "$GLOBAL_DIR/templates/knowledge/shared-services-template.md"
download_file "$REPO_URL/specwright/templates/knowledge/ui-components-template.md" "$GLOBAL_DIR/templates/knowledge/ui-components-template.md"

# Research templates (2)
echo "-> Research templates (2)..."
download_file "$REPO_URL/specwright/templates/research/research-notes.md" "$GLOBAL_DIR/templates/research/research-notes.md"
download_file "$REPO_URL/specwright/templates/research/research-questions.md" "$GLOBAL_DIR/templates/research/research-questions.md"
...
echo "  templates/ (~120 files)"
echo "    ├── product/ (11)"
echo "    ├── platform/ (7)"
echo "    ├── concept/ (7)"
echo "    ├── documents/ (16)"
echo "    ├── market-validation/ (7)"
echo "    ├── knowledge/ (5)"
echo "    ├── research/ (2)"
