---
description: Universal quality standards and checklists for Agent OS Web UI
globs: []
alwaysApply: true
---
...
- [ ] Color contrast meets WCAG AA (15:1 primary, 7:1 secondary)
...
- [ ] Component prefix is `aos-` (e.g., `aos-button`)
- [ ] Uses CSS Custom Properties for theming
- [ ] Reactive properties properly typed with `@property()`
- [ ] Events use `CustomEvent` with `bubbles: true, composed: true`
- [ ] Shadow DOM styles don't leak
...
```
.claude/skills/frontend-lit/dos-and-donts.md     # Frontend Learnings
.claude/skills/backend-express/dos-and-donts.md  # Backend Learnings
```
...
1. Prüfe ob ein Domain-Dokument existiert: `.claude/skills/domain-agent-os-web-ui/`
