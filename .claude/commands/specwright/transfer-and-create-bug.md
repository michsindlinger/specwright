...
**Requirements:** Active or completed brainstorming session about a bug in specwright/brainstorming/

Refer to the instructions located in @specwright/workflows/core/transfer-and-create-bug.md