...
**Requirements:** Active or completed brainstorming session in specwright/brainstorming/

Refer to the instructions located in @specwright/workflows/core/transfer-and-create-spec.md