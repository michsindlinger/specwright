...
| FA-22 | Wenn am Mac ein Schritt gestartet wird, MUSS die UI auf der Vorhaben-Seite bleiben (bei „Absicht beginnen": auf die neue Vorhaben-Seite wechseln, sobald der Ordner entsteht) und den Gesprächsbereich der neuen Sitzung zeigen; der Sprung ins Terminal MUSS als Knopf in der Kopfzeile bleiben. **Nachtrag 2026-09-16 (INT-2026-008):** Bei „Absicht beginnen" zeigt die Projekt-Seite den Gesprächsbereich der Sitzung ab dem Start, also vor dem Ordner; der Wechsel auf die Vorhaben-Seite folgt, sobald der Ordner entsteht, und das Interview steht dann im Protokoll des Vorhabens (AK-01 bis AK-07 dort). | Z-01, AK-06, AN-S03 (ändert INT-2026-004 FA-35 / INT-2026-005 Z-01) | Test + Playwright |
...
- **AN-S03:** Der Start eines Schritts springt am Mac nicht mehr ins Terminal (kehrt INT-2026-004 FA-35/AN-S14 und INT-2026-005 Z-01 um); „Im Terminal öffnen" bleibt als Knopf mit demselben Vollbild-Verhalten. Bei „Absicht beginnen" wechselt die UI auf die neue Vorhaben-Seite, sobald der Ordner entsteht; bis dahin zeigt die Projekt-Seite „Sitzung gestartet — Vorhaben entsteht". — bestätigt am 2026-09-16 von Product Owner; **Nachtrag 2026-09-16 (INT-2026-008):** bis dahin zeigt die Projekt-Seite am Mac den Gesprächsbereich der Sitzung (das Absicht-Interview läuft vor dem Ordner, `/intent` Schritt 2), am Handy den Hinweis mit „Im Terminal öffnen"; kein zweiter Start-Knopf solange die Sitzung anhängig ist.
