...
| FA-08 | Der Abschluss DARF den Hauptcheckout des Projekts NICHT verändern: kein Zweigwechsel, keine geänderte oder neue Datei, kein Nachholen, das dort etwas bewegt. Was er zum Schreiben braucht, MUSS er außerhalb des Hauptcheckouts tun und DARF keinen Rückstand hinterlassen (D1: Commit im temporären Index, keine Arbeitskopie). | AK-05 | Test |
...
| Temporärer Index für den Abschluss (kein Verzeichnis, keine Arbeitskopie — D1, Plan-Freigabe 2026-09-22) | entsteht als private Indexdatei ab dem entfernten Hauptzweig; verschwindet mit dem Ergebnis, ein Rest nach Absturz ist wirkungslos | niemand (nicht in der UI gelistet) | intern (Host-Pfad nie in der UI) |
...
| architecture.md §2 Backend (Aufräumer-Schutzregel `keepWorktree`, INT-2026-019) | Die kurzlebige Abschluss-Kopie darf nicht als Sitzungs-Kopie gelten und muss beim Backend-Start als Rest erkannt und entfernt werden | FA-08, FA-17, Randfall „Backend stürzt ab" | entfällt (D1, Plan-Freigabe 2026-09-22): der Abschluss legt keine Arbeitskopie an — Commit im temporären Index; kein Aufräumer nötig, der Aufräumer der Sitzungs-Kopien bleibt unberührt |
...
- [x] D1 (Plan-Freigabe, 2026-09-22): Technik „Commit ohne Arbeitskopie" (temporärer Index statt kurzlebiger Arbeitskopie) — Ziel FA-08 unverändert (Hauptcheckout unberührt, kein Rückstand); Wortlaut von FA-08 Satz 2, §5 und §7 in der Bausitzung angepasst; kein neuer Freigabelauf, kein ADR (Technikwahl)
