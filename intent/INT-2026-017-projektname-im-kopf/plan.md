...
- [x] `bash scripts/verify.sh` → lokal `verify: ROT` allein wegen vorbestehendem `terminal-io.test.ts` (§14, auch auf `main`); Ausgabe im PR. **PR-Check `verify` grün** (Lauf 35263712088, 1 m 46 s) — damit erfüllt, CI ist die Wahrheit.
