...
> Stufe 1 fertig (PR #44, gemergt 15.09.) · Stufe 2 fertig (Branch `feat/INT-2026-004-ui-s2`, PR #45, CI grün) · nächste: **Stufe 3 ab Schritt 0** (Konsumentenliste, Abbau)
...
- Letzter prüfbarer Zustand: `bash scripts/verify.sh` → `verify: OK`; CI-Check `verify` auf PR #45 grün.
