...
export class AosSendeLeiste extends LitElement {
  ...
  static override styles = css`
    /* Mac: fixed above the page (main-content has overflow-x:hidden, so sticky
       would never engage), full width from the left up to the terminal
       sidebar — docked as the right column of the page or floating, the
       sidebar publishes its width as --terminal-open-width (INT-2026-011, FA-01/FA-05). */
    :host {
      display: block;
      position: fixed;
      bottom: 0;
