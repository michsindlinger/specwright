...
| 2026-09-18 | §3 neue Zeile „Bilder aus „Neue Absicht"" (`<runtime>/intent-paste/`, 7 Tage, beim Start aufgeräumt; Prüf- und Ablagefunktion mit dem Terminal geteilt), §8 ADR-0005 — keine AR-Änderung, AR-04/AR-05 eingehalten, ADR-0002 unverändert (INT-2026-020) | ADR-0005 |
