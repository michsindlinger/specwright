...
| 2026-09-18 | §2 Backend: „Nächster Schritt in der Sitzung" (Freigabe-Regel `deriveNextStepSperre`, `/clear` + Phasen-Befehl unter einem Maschinen-Lock mit Warten auf die neue Gesprächskennung, Schließen der alten Sitzung als Nutzer); §3 Nutzerzustand: der Klick verschiebt die Zuordnung wie ein getippter Befehl — keine AR-Änderung, AR-02/AR-04/AR-05 eingehalten, ADR-0002 und ADR-0004 unverändert (INT-2026-018) | PR folgt |
