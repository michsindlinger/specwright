---
description: Spec Phase 3 - Execute one user story (JSON v5.6)
version: 5.6
---
...
- kanban.json exists in main repo
...
<phase_complete>
  ### Check Remaining Stories (via MCP)
  ...
  IF response.remaining > 0:
    ...
    Input:
    {
      ...
      "lastAction": "Completed {SELECTED_STORY.id}",
