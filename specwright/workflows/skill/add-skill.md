...
<instructions>
  ...
  READ: @specwright/workflows/skill/validation/best-practices/{framework}.md
...
<instructions>
  ...
  PRIORITY_1: Check specwright/config.yml
  ...
  OPTIONAL: Save to config
    IF specwright/config.yml exists:
      ASK: "Save project name to specwright/config.yml?"
      IF yes:
        READ: specwright/config.yml
...
<instructions>
  ACTION: Load appropriate template
    template_path = "@specwright/templates/skills/{skill_type}-patterns.md.template"

    IF skill_type == "api":
      READ: @specwright/templates/skills/api-patterns.md.template
    ELSE IF skill_type == "component":
      READ: @specwright/templates/skills/component-patterns.md.template
    ELSE IF skill_type == "testing":
      READ: @specwright/templates/skills/testing-patterns.md.template
    ELSE IF skill_type == "deployment":
      READ: @specwright/templates/skills/deployment-patterns.md.template
