...
**Estimated Effort**: S
**Dependencies**: IW-998 (Integration Validation)
...
- [ ] FILE_EXISTS: specwright/specs/2026-02-16-installation-wizard/user-todos.md (wenn manuelle Tasks vorhanden)
...
**WO:**
- Output: `specwright/specs/2026-02-16-installation-wizard/user-todos.md` (aktualisiert)
- Output: `specwright/knowledge/knowledge-index.md` (wenn Artefakte vorhanden)
- Output: Pull Request auf GitHub

**Abhaengigkeiten:** IW-998
