...
|-----------|-------|------------------|----------|----------------------|
| UI Components | ui-components.md | UI, Component, Button, Form, Modal, Input, Frontend, Widget | 17 | 2026-03-01 |
| API Contracts | api-contracts.md | API, Endpoint, REST, Backend, Route, Controller | 5 | 2026-02-27 |
| Shared Services | shared-services.md | Service, Hook, Utility, Helper, Provider | 13 | 2026-03-01 |
...
**Services:** FileService, FileHandler, GitService, isSpecReady, toggleBotAssignment, McpConfigReaderService, VoiceConfigService, DeepgramAdapter, ElevenLabsAdapter, AudioCaptureService, VoiceCallService, AudioPlaybackService, TranscriptService
